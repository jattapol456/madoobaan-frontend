<template lang="pug">
  .flex.flex-col.input-wrapper.w-full(:class="{ 'is-disabled': disabled, 'has-prefix-icon': prefixIcon, 'has-suffix-icon': suffixIcon, 'has-prefix': prefix, 'has-suffix': suffix }")
